...
func Test1(t *testing.T) {
	...
	resList := []string{
		"K:00432100 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x31, 0x30}(8) V:00 H:0 LH:0 SN:0",
		"K:00432110 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x32, 0x30}(8) V:10 H:0 LH:0 SN:1",
		"K:00432120 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x33, 0x30}(8) V:20 H:0 LH:0 SN:2",
		"K:00432130 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x34, 0x30}(8) V:30 H:0 LH:0 SN:3",
		"K:00432140 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x35, 0x30}(8) V:40 H:0 LH:0 SN:4",
		"K:00432150 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x36, 0x30}(8) V:50 H:0 LH:0 SN:5",
		"K:00432160 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x37, 0x30}(8) V:60 H:0 LH:0 SN:6",
		"K:00432170 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x38, 0x30}(8) V:70 H:0 LH:0 SN:7",
		"K:00432180 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x39, 0x30}(8) V:80 H:0 LH:0 SN:8",
		"K:00432190 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x61, 0x30}(8) V:90 H:0 LH:0 SN:9",
		"K:004321a0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x62, 0x30}(8) V:a0 H:0 LH:0 SN:10",
		"K:004321b0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x63, 0x30}(8) V:b0 H:0 LH:0 SN:11",
		"K:004321c0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x64, 0x30}(8) V:c0 H:0 LH:0 SN:12",
		"K:004321d0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x65, 0x30}(8) V:d0 H:0 LH:0 SN:13",
		"K:004321e0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x66, 0x30}(8) V:e0 H:0 LH:0 SN:14",
		"K:004321f0 nK:[]byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}(8) V:f0 H:0 LH:0 SN:15",
	}
	...
	assert.Equal(t, "K:00432100 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x32, 0x30}(8) V:00 H:1 LH:0 SN:16", EntryToStr(e))
	e = ads.GetEntry([]byte("00432110"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("00432120"))
	assert.Equal(t, "K:00432120 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x34, 0x34}(8) V:20 H:1 LH:0 SN:17", EntryToStr(e))
	e = ads.GetEntry([]byte("00432130"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("00432140"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("00432144"))
	assert.Equal(t, "K:00432144 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x35, 0x35}(8) V:444 H:1 LH:0 SN:18", EntryToStr(e))
	e = ads.GetEntry([]byte("00432150"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("00432155"))
	assert.Equal(t, "K:00432155 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x36, 0x30}(8) V:555 H:1 LH:0 SN:19", EntryToStr(e))
	e = ads.GetEntry([]byte("00432160"))
	assert.Equal(t, "K:00432160 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x36, 0x36}(8) V:60 H:1 LH:0 SN:20", EntryToStr(e))
	e = ads.GetEntry([]byte("00432166"))
	assert.Equal(t, "K:00432166 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x37, 0x37}(8) V:666 H:1 LH:0 SN:21", EntryToStr(e))
	e = ads.GetEntry([]byte("00432170"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("00432177"))
	assert.Equal(t, "K:00432177 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x38, 0x30}(8) V:777 H:1 LH:0 SN:22", EntryToStr(e))
	...
	assert.Equal(t, "K:00432188 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x39, 0x30}(8) V:888 H:1 LH:0 SN:24", EntryToStr(e))
	e = ads.GetEntry([]byte("00432190"))
	assert.Equal(t, "K:00432190 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x61, 0x30}(8) V:90 H:0 LH:0 SN:9", EntryToStr(e))
	e = ads.GetEntry([]byte("004321a0"))
	assert.Equal(t, "K:004321a0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x61, 0x61}(8) V:a0 H:1 LH:0 SN:25", EntryToStr(e))
	e = ads.GetEntry([]byte("004321aa"))
	assert.Equal(t, "K:004321aa nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x62, 0x62}(8) V:aaa H:1 LH:0 SN:0", EntryToStr(e))
	e = ads.GetEntry([]byte("004321b0"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("004321bb"))
	assert.Equal(t, "K:004321bb nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x63, 0x30}(8) V:bbb H:1 LH:0 SN:1", EntryToStr(e))
	e = ads.GetEntry([]byte("004321c0"))
	assert.Equal(t, "K:004321c0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x65, 0x30}(8) V:c0 H:1 LH:0 SN:26", EntryToStr(e))
	e = ads.GetEntry([]byte("004321d0"))
	assert.Nil(t, e)
	e = ads.GetEntry([]byte("004321e0"))
	assert.Equal(t, "K:004321e0 nK:[]byte{0x30, 0x30, 0x34, 0x33, 0x32, 0x31, 0x66, 0x30}(8) V:e0 H:0 LH:0 SN:14", EntryToStr(e))
	e = ads.GetEntry([]byte("004321f0"))
	assert.Equal(t, "K:004321f0 nK:[]byte{0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff}(8) V:f0 H:0 LH:0 SN:15", EntryToStr(e))
